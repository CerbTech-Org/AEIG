...
@RoutePage()
class BorrowObjectScreen extends StatefulWidget {
  const BorrowObjectScreen({super.key});

  @override
  State<BorrowObjectScreen> createState() => _BorrowObjectScreenState();
}

class _BorrowObjectScreenState extends State<BorrowObjectScreen> {
