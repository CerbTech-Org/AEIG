...
@RoutePage()
class EditInventoryFormScreen extends StatefulWidget {
  // stock les inventaires sous forme de clé et valeur
  final Map<String, dynamic> item;

  const EditInventoryFormScreen({super.key, required this.item});

  @override
  _EditInventoryFormScreenState createState() => _EditInventoryFormScreenState();
}

class _EditInventoryFormScreenState extends State<EditInventoryFormScreen> {
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.inventory, color: Colors.lightBlue),
                filled: true,
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
                prefixIcon: const Icon(Icons.add_box, color: Colors.lightBlue),
                filled: true,
                fillColor: Colors.white,
              ),
              style: GoogleFonts.poppins(),
