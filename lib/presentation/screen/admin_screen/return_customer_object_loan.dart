...
@RoutePage()
class ReturnCustomerObjectLoanScreen extends StatefulWidget {
  const ReturnCustomerObjectLoanScreen({super.key});

  @override
  State<ReturnCustomerObjectLoanScreen> createState() => _ReturnCustomerObjectLoanScreenState();
}

class _ReturnCustomerObjectLoanScreenState extends State<ReturnCustomerObjectLoanScreen> {
  @override
