...
@RoutePage()
class AcceptationCustomerObjectLoanScreen extends StatefulWidget {
  const AcceptationCustomerObjectLoanScreen({super.key});

  @override
  State<AcceptationCustomerObjectLoanScreen> createState() => _AcceptationCustomerObjectLoanScreenState();
}

class _AcceptationCustomerObjectLoanScreenState extends State<AcceptationCustomerObjectLoanScreen> {
